                        ...
                        <table class="min-w-full">
                            <thead>
                                <tr class="border-b border-gray-50">
                                    ...
                                    <th class="px-6 py-4 text-left text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Contact</th>
                            ...
                            <tbody class="divide-y divide-gray-50">
                                @foreach ($suppliers as $supplier)
                                    <tr class="hover:bg-silk/50 transition-colors group">
                                        ...
                                        <td class="px-6 py-6 whitespace-nowrap text-sm font-bold text-royal-navy">
                                            {{ $supplier->phone }}
                                        </td>
