    ...
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mt-1">Perbarui Detail Menu & Informasi Hidangan</p>
            </div>
        </div>
    </x-slot>
                        ...
                        <div class="space-y-8">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="3"
                                    class="w-full px-6 py-4 bg-silk border-2 border-transparent rounded-2xl text-sm font-bold text-royal-navy placeholder-gray-400 focus:bg-white focus:border-gold focus:ring-4 focus:ring-gold/10 transition-all outline-none"
                                    placeholder="Penjelasan singkat mengenai hidangan">{{ old('description', $dish->description) }}</textarea>
