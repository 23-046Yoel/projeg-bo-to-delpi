                                    ...
                                    <tr class="hover:bg-gold/5 transition-colors group">
                                        ...
                                        <td class="px-4 py-4 whitespace-nowrap text-center">
                                            <div class="flex items-center justify-center space-x-2">
                                                <a href="{{ route('menus.show', $menu) }}" title="Lihat Detail" class="p-2 bg-royal-navy text-gold rounded-lg hover:bg-royal-navy/90 shadow-md transition-all">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                                </a>
                                                <a href="{{ route('menus.edit', $menu) }}" title="Edit Menu" class="p-2 bg-silk text-royal-navy border border-gray-100 rounded-lg hover:bg-gray-100 shadow-sm transition-all">
