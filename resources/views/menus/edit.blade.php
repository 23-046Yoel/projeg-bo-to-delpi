    ...
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mt-1">Perbarui Menu & Estimasi Porsi</p>
            </div>
        </div>
    </x-slot>
                ...
                <form action="{{ route('menus.update', $menu) }}" method="POST" id="menuForm">
                    ...
                    <div class="space-y-10">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div>
                                <label class="block text-[10px] font-black text-royal-navy uppercase tracking-[0.2em] mb-3">Kitchen (Dapur/SPPG)</label>
                            ...
                            <div id="dishContainer" class="space-y-6 sm:space-y-4">
                                ...
                                <div class="dish-row grid grid-cols-12 gap-3 sm:gap-4 items-center animate-fadeIn bg-silk sm:bg-transparent p-4 sm:p-0 rounded-2xl sm:rounded-none border sm:border-0 border-gray-100/50">
                                    ...
                                    <div class="col-span-8 sm:col-span-3">
                                        ...
                                        <input type="number" name="dishes[{{ $index }}][portions]" value="{{ $selectedDish->pivot->portions }}" required min="1" class="w-full px-5 sm:px-6 py-3 sm:py-4 bg-white sm:bg-silk border-2 border-transparent rounded-2xl text-sm font-black text-royal-navy focus:bg-white focus:border-gold outline-none" placeholder="Qty">
                                    </div>
