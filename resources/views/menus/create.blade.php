        ...
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h2 class="font-black text-2xl text-royal-navy leading-tight tracking-tight uppercase font-playfair">
                    {{ __('Rencanakan Menu Harian') }}
                </h2>
                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mt-1">Tentukan Menu & Estimasi Porsi Ganda</p>
            </div>
        </div>
    </x-slot>
                            ...
                            <div id="dishContainer" class="space-y-6 sm:space-y-4">
                                ...
                                <div class="dish-row grid grid-cols-12 gap-3 sm:gap-4 items-center animate-fadeIn bg-silk sm:bg-transparent p-4 sm:p-0 rounded-2xl sm:rounded-none border sm:border-0 border-gray-100/50">
                                    ...
                                    <div class="col-span-6 sm:col-span-2">
                                        ...
                                        <input type="number" name="dishes[0][porsi_besar]" required min="0" class="w-full px-4 py-3 sm:py-4 bg-white sm:bg-silk border-2 border-transparent rounded-2xl text-sm font-black text-royal-navy focus:bg-white focus:border-gold outline-none" placeholder="Besar">
                                    </div>
                                    <div class="col-span-6 sm:col-span-2">
                                        ...
                                        <input type="number" name="dishes[0][porsi_kecil]" required min="0" class="w-full px-4 py-3 sm:py-4 bg-white sm:bg-silk border-2 border-transparent rounded-2xl text-sm font-black text-royal-navy focus:bg-white focus:border-gold outline-none" placeholder="Kecil">
                                    </div>
    ...
    <script>
        ...
        async function autoFillPortions() {
            ...
            try {
                ...
                alert('Gagal mengambil data porsi. Pastikan Unit Dapur sudah dipilih.');
            }
        }
    </script>
</x-app-layout>
