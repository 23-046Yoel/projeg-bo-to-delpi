                            ...
                            <div class="menu-card">
                                ...
                                <div class="menu-items">
                                    ...
                                    <div style="margin-top: 12px; padding: 12px; background: #fffbeb; border-radius: 12px; border: 1px dashed #f0c040;">
                                        ...
                                        <a href="{{ route('offers.form') }}" style="display: inline-block; margin-top: 8px; font-size: 10px; font-weight: 800; color: #0f1e40; text-decoration: underline; text-transform: uppercase; letter-spacing: 1px;">DAFTAR JADI PEMASOK →</a>
                                    </div>
                                    @endif
                                </div>
                            </div>
