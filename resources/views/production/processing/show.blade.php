                ...
                <div class="premium-card p-8 mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="datetime-local" name="proc_start" value="{{ $menu->productionLog->proc_start ? \Carbon\Carbon::parse($menu->productionLog->proc_start)->format('Y-m-d\TH:i') : '' }}" class="w-full px-5 py-3 bg-silk/30 border-2 border-transparent rounded-xl text-xs font-bold text-royal-navy focus:border-gold outline-none transition-all">
                        </div>
                        <div>
                            <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Jam Selesai Seluruh Proses</label>
                            <input type="datetime-local" name="proc_end" value="{{ $menu->productionLog->proc_end ? \Carbon\Carbon::parse($menu->productionLog->proc_end)->format('Y-m-d\TH:i') : '' }}" class="w-full px-5 py-3 bg-silk/30 border-2 border-transparent rounded-xl text-xs font-bold text-royal-navy focus:border-gold outline-none transition-all">
                        </div>
                    </div>
                </div>
