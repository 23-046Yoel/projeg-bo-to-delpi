    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mt-1">Laporan Persiapan Bahan Baku</p>
            </div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8 p-6 bg-white rounded-[1.5rem] border border-gray-100 shadow-sm">
                <form action="{{ route('production.preparation.index') }}" method="GET" class="flex flex-wrap items-end gap-6">
                    ...
                    <div class="flex-1 flex items-center mb-1">
                        @if(request('sppg_id') || request('date'))
                            <a href="{{ route('production.preparation.index') }}" class="text-[10px] font-black text-rose-500 uppercase tracking-widest hover:text-rose-600 transition-colors flex items-center">
                                ...
                                @forelse ($menus as $menu)
                                    <tr class="hover:bg-gold/5 transition-colors group">
                                        ...
                                        <td class="px-4 py-4 whitespace-nowrap text-center">
                                            <a href="{{ route('production.preparation.show', $menu) }}" class="inline-flex items-center px-4 py-2 bg-gold text-royal-navy text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-gold/80 transition-all shadow-lg shadow-gold/20">
                                                Isi Laporan
                                            </a>
                                        </td>
                                    </tr>
