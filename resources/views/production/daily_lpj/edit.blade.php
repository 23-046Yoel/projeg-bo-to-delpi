<x-app-layout>
    ...
    <div class="py-12 bg-silk/50 min-h-screen">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('production.daily-lpj.update', $dailyLpj) }}" method="POST" id="lpjForm">
                @csrf
                @method('PUT')
                <input type="hidden" name="menu_id" value="{{ $dailyLpj->menu_id }}">
                <input type="hidden" name="sppg_id" value="{{ $dailyLpj->sppg_id }}">
                <input type="hidden" name="date" value="{{ $dailyLpj->date->toDateString() }}">
                        ...
                        <div>
                            ...
                            <div class="space-y-4">
                                <div class="grid grid-cols-3 items-center">
                                    ...
                                    <span class="col-span-2 text-xs font-black text-royal-navy">: {{ $dailyLpj->sppg->name }}</span>
                                </div>
                                <div class="grid grid-cols-3 items-center">
                                    <span class="text-[10px] font-bold text-gray-400 uppercase">Tanggal</span>
                                    <span class="col-span-2 text-xs font-black text-royal-navy">: {{ $dailyLpj->date->translatedFormat('d F Y') }}</span>
                                </div>
                                <div class="grid grid-cols-3 items-center">
                                    <span class="text-[10px] font-bold text-gray-400 uppercase">Menu Utama</span>
                                    <span class="col-span-2 text-xs font-black text-royal-navy uppercase">: {{ $dailyLpj->menu->karbo }}</span>
                                </div>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center justify-between">
                                    ...
                                    <input type="number" step="0.01" name="total_production" value="{{ $dailyLpj->total_production }}" class="w-32 px-3 py-1 bg-silk/50 border-b border-gray-200 text-xs font-black text-right focus:border-gold outline-none">
                                </div>
                                <div class="flex items-center justify-between">
                                    <label class="text-[10px] font-bold text-gray-400 uppercase">Total Distribusi</label>
                                    <input type="number" step="0.01" name="total_distribution" value="{{ $dailyLpj->total_distribution }}" class="w-32 px-3 py-1 bg-silk/50 border-b border-gray-200 text-xs font-black text-right focus:border-gold outline-none">
                                </div>
                                <div class="flex items-center justify-between">
                                    <label class="text-[10px] font-bold text-gray-400 uppercase">Sisa Makanan</label>
                                    <input type="number" step="0.01" name="leftover_food" value="{{ $dailyLpj->leftover_food }}" class="w-32 px-3 py-1 bg-silk/50 border-b border-gray-200 text-xs font-black text-right focus:border-gold outline-none">
                                </div>
                                <div class="flex items-center justify-between">
                                    <label class="text-[10px] font-bold text-gray-400 uppercase">Food Waste</label>
                                    <input type="number" step="0.01" name="food_waste" value="{{ $dailyLpj->food_waste }}" class="w-32 px-3 py-1 bg-silk/50 border-b border-gray-200 text-xs font-black text-right focus:border-gold outline-none">
                                </div>
                                <div class="flex items-center justify-between">
                                    <label class="text-[10px] font-bold text-gray-400 uppercase">Total Pengeluaran</label>
                                    <input type="number" step="0.01" name="total_expenditure" value="{{ $dailyLpj->total_expenditure }}" class="w-32 px-3 py-1 bg-silk/50 border-b border-gray-200 text-xs font-black text-right focus:border-gold outline-none">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="premium-card p-8">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between border-b border-gray-100 pb-2">
                                ...
                                <span class="text-[10px] font-black text-royal-navy uppercase">{{ $dailyLpj->menu->karbo }}</span>
                            </div>
                            <div class="flex justify-between border-b border-gray-100 pb-2">
                                <span class="text-[10px] font-bold text-gray-400 uppercase">Protein Hewani</span>
                                <span class="text-[10px] font-black text-royal-navy uppercase">{{ $dailyLpj->menu->protein_hewani }}</span>
                            </div>
                            <div class="flex justify-between border-b border-gray-100 pb-2">
                                <span class="text-[10px] font-bold text-gray-400 uppercase">Protein Nabati</span>
                                <span class="text-[10px] font-black text-royal-navy uppercase">{{ $dailyLpj->menu->protein_nabati }}</span>
                            </div>
                            <div class="flex justify-between border-b border-gray-100 pb-2">
                                <span class="text-[10px] font-bold text-gray-400 uppercase">Sayur</span>
                                <span class="text-[10px] font-black text-royal-navy uppercase">{{ $dailyLpj->menu->sayur }}</span>
                            </div>
                            <div class="flex justify-between border-b border-gray-100 pb-2">
                                <span class="text-[10px] font-bold text-gray-400 uppercase">Buah</span>
                                <span class="text-[10px] font-black text-royal-navy uppercase">{{ $dailyLpj->menu->buah }}</span>
                            </div>
                            <div class="flex justify-between pt-2">
                                <span class="text-[10px] font-bold text-gold-dark uppercase">Total Energi / Protein</span>
                                <span class="text-[10px] font-black text-gold-dark">{{ $dailyLpj->menu->energy ?? 0 }} kkal / {{ $dailyLpj->menu->protein ?? 0 }} g</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="premium-card p-8">
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full text-[10px]" id="receiptsTable">
                                ...
                                <tbody>
                                    @foreach($dailyLpj->material_receipts ?? [] as $index => $item)
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div>
                            ...
                            <table class="w-full text-[10px]" id="prepTable">
                                ...
                                <tbody>
                                    @foreach($dailyLpj->haccp_preparation ?? [] as $index => $item)
                                        <tr class="border-b border-gray-50">
                        ...
                        <div>
                            ...
                            <table class="w-full text-[10px]" id="procTable">
                                ...
                                <tbody>
                                    @foreach($dailyLpj->haccp_processing ?? [] as $index => $item)
                                        <tr class="border-b border-gray-50">
                ...
                <div class="premium-card p-8 mb-8">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-[10px]" id="distTable">
                            ...
                            <tbody>
                                @foreach($dailyLpj->distribution_data ?? [] as $index => $item)
                                    <tr class="border-b border-gray-50">
                        ...
                        <table class="w-full text-[10px]">
                            ...
                            <tbody class="space-y-1">
                                <tr class="border-b border-gray-50">
                                    ...
                                    <td><input type="number" step="0.01" name="initial_balance_virtual" value="{{ $dailyLpj->initial_balance_virtual }}" class="w-full bg-transparent border-none p-0 text-right font-black text-royal-navy focus:ring-0"></td>
                                    <td><input type="number" step="0.01" name="initial_balance_cash" value="{{ $dailyLpj->initial_balance_cash }}" class="w-full bg-transparent border-none p-0 text-right font-black text-royal-navy focus:ring-0"></td>
                                </tr>
                                <tr class="border-b border-gray-50">
                                    <td class="py-2 text-gray-600 font-bold">Pengeluaran Bahan Baku</td>
                                    <td><input type="number" step="0.01" name="expenditure_materials_virtual" value="{{ $dailyLpj->expenditure_materials_virtual }}" class="w-full bg-transparent border-none p-0 text-right font-black text-royal-navy focus:ring-0"></td>
                                    <td><input type="number" step="0.01" name="expenditure_materials_cash" value="{{ $dailyLpj->expenditure_materials_cash }}" class="w-full bg-transparent border-none p-0 text-right font-black text-royal-navy focus:ring-0"></td>
                                </tr>
                                <tr class="border-b border-gray-100 bg-gray-50/50">
                                    <td class="py-2 text-royal-navy font-black uppercase text-[9px]">Pengeluaran Operasional</td>
                                    <td class="text-right py-2 pr-2 font-black text-royal-navy text-[10px]" id="ops_total_virtual_display">Rp {{ number_format($dailyLpj->expenditure_ops_salary_virtual + $dailyLpj->expenditure_ops_gas_virtual + $dailyLpj->expenditure_ops_electricity_virtual + $dailyLpj->expenditure_ops_admin_virtual, 0, ',', '.') }}</td>
                                    <td class="text-right py-2 pr-2 font-black text-royal-navy text-[10px]" id="ops_total_cash_display">Rp {{ number_format($dailyLpj->expenditure_ops_salary_cash + $dailyLpj->expenditure_ops_gas_cash + $dailyLpj->expenditure_ops_electricity_cash + $dailyLpj->expenditure_ops_admin_cash, 0, ',', '.') }}</td>
                                </tr>
                                <tr>
                                    <td class="py-2 text-gray-400 font-bold uppercase text-[8px] pl-4">1. Gaji Relawan</td>
                                    <td><input type="number" step="0.01" name="expenditure_ops_salary_virtual" value="{{ $dailyLpj->expenditure_ops_salary_virtual }}" class="w-full bg-transparent border-none p-0 text-right font-bold text-gray-500 focus:ring-0"></td>
                                    <td><input type="number" step="0.01" name="expenditure_ops_salary_cash" value="{{ $dailyLpj->expenditure_ops_salary_cash }}" class="w-full bg-transparent border-none p-0 text-right font-bold text-gray-500 focus:ring-0"></td>
                                </tr>
                                <tr>
                                    <td class="py-2 text-gray-400 font-bold uppercase text-[8px] pl-4">2. Gas</td>
                                    <td><input type="number" step="0.01" name="expenditure_ops_gas_virtual" value="{{ $dailyLpj->expenditure_ops_gas_virtual }}" class="w-full bg-transparent border-none p-0 text-right font-bold text-gray-500 focus:ring-0"></td>
                                    <td><input type="number" step="0.01" name="expenditure_ops_gas_cash" value="{{ $dailyLpj->expenditure_ops_gas_cash }}" class="w-full bg-transparent border-none p-0 text-right font-bold text-gray-500 focus:ring-0"></td>
                                </tr>
                                <tr>
                                    <td class="py-2 text-gray-400 font-bold uppercase text-[8px] pl-4">3. Listrik</td>
                                    <td><input type="number" step="0.01" name="expenditure_ops_electricity_virtual" value="{{ $dailyLpj->expenditure_ops_electricity_virtual }}" class="w-full bg-transparent border-none p-0 text-right font-bold text-gray-500 focus:ring-0"></td>
                                    <td><input type="number" step="0.01" name="expenditure_ops_electricity_cash" value="{{ $dailyLpj->expenditure_ops_electricity_cash }}" class="w-full bg-transparent border-none p-0 text-right font-bold text-gray-500 focus:ring-0"></td>
                                </tr>
                                <tr class="border-b border-gray-50">
                                    <td class="py-2 text-gray-400 font-bold uppercase text-[8px] pl-4">4. Administrasi</td>
                                    <td><input type="number" step="0.01" name="expenditure_ops_admin_virtual" value="{{ $dailyLpj->expenditure_ops_admin_virtual }}" class="w-full bg-transparent border-none p-0 text-right font-bold text-gray-500 focus:ring-0"></td>
                                    <td><input type="number" step="0.01" name="expenditure_ops_admin_cash" value="{{ $dailyLpj->expenditure_ops_admin_cash }}" class="w-full bg-transparent border-none p-0 text-right font-bold text-gray-500 focus:ring-0"></td>
                                </tr>
                                <tr class="border-b border-gray-50">
                                    <td class="py-2 text-gray-600 font-bold">Pengeluaran Insentif</td>
                                    <td><input type="number" step="0.01" name="expenditure_incentive_virtual" value="{{ $dailyLpj->expenditure_incentive_virtual }}" class="w-full bg-transparent border-none p-0 text-right font-black text-royal-navy focus:ring-0"></td>
                                    <td><input type="number" step="0.01" name="expenditure_incentive_cash" value="{{ $dailyLpj->expenditure_incentive_cash }}" class="w-full bg-transparent border-none p-0 text-right font-black text-royal-navy focus:ring-0"></td>
                                </tr>
                                <tr>
                                    <td class="py-3 text-royal-navy font-black uppercase text-[11px]">Saldo Akhir</td>
                                    <td><input type="number" step="0.01" name="final_balance_virtual" value="{{ $dailyLpj->final_balance_virtual }}" class="w-full bg-transparent border-none p-0 text-right font-black text-gold-dark text-sm focus:ring-0"></td>
                                    <td><input type="number" step="0.01" name="final_balance_cash" value="{{ $dailyLpj->final_balance_cash }}" class="w-full bg-transparent border-none p-0 text-right font-black text-gold-dark text-sm focus:ring-0"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                    <div class="premium-card p-8">
                        ...
                        <textarea name="conclusion" rows="4" class="w-full bg-silk/30 border-2 border-transparent rounded-xl text-xs font-bold p-4 focus:border-gold outline-none transition-all">{{ $dailyLpj->conclusion }}</textarea>
                    </div>
                    <div class="premium-card p-8">
                        <h3 class="text-xs font-black text-royal-navy uppercase tracking-[0.2em] mb-6">PENGESAHAN</h3>
                        <div class="space-y-3">
                            @foreach($dailyLpj->signatures as $role => $name)
