    ...
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mt-1">Isi formulir berikut untuk mencatat aset baru</p>
            </div>
        </div>
    </x-slot>
                        ...
                        <div class="space-y-8">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div>
                                    ...
                                    <input type="text" name="code" id="code" value="{{ old('code') }}" required placeholder="Contoh: AST-001"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="Contoh: Timbangan Digital / Avanza"
                                        class="w-full px-6 py-4 bg-silk border-2 border-transparent rounded-2xl text-sm font-bold text-royal-navy focus:bg-white focus:border-gold transition-all outline-none">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div>
                                    ...
                                    <input type="number" name="qty" id="qty" value="{{ old('qty', 1) }}" required min="1"
                                        class="w-full px-6 py-4 bg-silk border-2 border-transparent rounded-2xl text-sm font-bold text-royal-navy focus:bg-white focus:border-gold transition-all outline-none">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="4" placeholder="Keterangan tambahan mengenai kondisi atau detail aset..."
                                    class="w-full px-6 py-4 bg-silk border-2 border-transparent rounded-2xl text-sm font-bold text-royal-navy focus:bg-white focus:border-gold transition-all outline-none resize-none">{{ old('description') }}</textarea>
