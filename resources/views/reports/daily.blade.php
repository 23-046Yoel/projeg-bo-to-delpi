            ...
            <form action="{{ route('reports.daily.store') }}" method="POST" enctype="multipart/form-data" class="p-10 space-y-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <label class="relative flex items-center justify-center p-5 rounded-[1.5rem] border-2 border-gold/5 bg-silk hover:border-gold-premium/30 cursor-pointer transition-all has-[:checked]:border-gold-premium has-[:checked]:bg-gold-light/20 group overflow-hidden">
                            <input type="radio" name="report_type" value="Harian Pengolahan" class="hidden">
                            <div class="text-center">
                                <span class="block text-[11px] font-black text-royal-navy group-hover:text-gold-dark uppercase tracking-wider">Harian Pengolahan</span>
                            </div>
                        </label>
                        <label class="relative flex items-center justify-center p-5 rounded-[1.5rem] border-2 border-gold/5 bg-silk hover:border-gold-premium/30 cursor-pointer transition-all has-[:checked]:border-gold-premium has-[:checked]:bg-gold-light/20 group overflow-hidden">
                            <input type="radio" name="report_type" value="Harian Pemorsian" class="hidden">
                            <div class="text-center">
                                <span class="block text-[11px] font-black text-royal-navy group-hover:text-gold-dark uppercase tracking-wider">Harian Pemorsian</span>
                            </div>
                        </label>
                        <label class="relative flex items-center justify-center p-5 rounded-[1.5rem] border-2 border-gold/5 bg-silk hover:border-gold-premium/30 cursor-pointer transition-all has-[:checked]:border-gold-premium has-[:checked]:bg-gold-light/20 group overflow-hidden">
