    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mt-1">Input Data Arus Bahan SPPG</p>
            </div>
            <div class="flex items-center space-x-2 text-[10px] font-bold text-gray-300 tracking-widest uppercase">
                <span>Inventory</span>
                <span class="text-gold">/</span>
                <span class="text-royal-navy">New Log</span>
            </div>
        </div>
    </x-slot>
            ...
            <div class="bg-white rounded-[3rem] shadow-[0_40px_80px_rgba(15,23,42,0.05)] border border-gray-100 overflow-hidden relative">
                ...
                <div class="p-12 relative">
                    <div class="mb-10 text-center">
                        <div class="w-16 h-16 bg-royal-navy rounded-2xl flex items-center justify-center text-gold mx-auto mb-6 shadow-xl shadow-royal-navy/20">
                        ...
                        <h3 class="text-2xl font-black text-royal-navy font-playfair tracking-tight mb-2">Formulir Input Stok</h3>
                        <p class="text-sm text-gray-400 font-medium">Pastikan data yang diinput sudah sesuai dengan fisik barang.</p>
                    </div>

                    <form action="{{ route('material_logs.store') }}" method="POST" class="space-y-8">
                        @csrf
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        <select id="type" name="type" class="bg-silk border-transparent focus:border-gold focus:ring-4 focus:ring-gold/10 rounded-2xl py-4 px-6 w-full text-royal-navy font-bold appearance-none transition-all">
                                            <option value="in" {{ old('type') == 'in' ? 'selected' : '' }}>🟢 Bahan Masuk (Masuk)</option>
                                            <option value="out" {{ old('type') == 'out' ? 'selected' : '' }}>🔴 Bahan Keluar (Pakai)</option>
                                        </select>
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input id="quantity" class="pl-16 w-full" type="number" step="1" min="1" name="quantity" :value="old('quantity')" required placeholder="0" />
                                    </div>
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    ...
                                    <x-text-input id="date" class="pl-14 w-full" type="date" name="date" :value="old('date', date('Y-m-d'))" required />
                                </div>
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    ...
                                    <x-text-input id="notes" class="pl-14 w-full" type="text" name="notes" :value="old('notes')" placeholder="Contoh: Tambahan stok dari relawan, barang cacat, dll." />
                                </div>
                        ...
                        <div class="pt-6 border-t border-gray-50 flex items-center justify-between">
                            <a href="{{ route('material_logs.index') }}" class="text-[10px] font-black text-gray-300 uppercase tracking-widest hover:text-royal-navy transition-colors">Batal & Kembali</a>
