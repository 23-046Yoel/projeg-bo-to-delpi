                ...
                <form action="{{ route('beneficiary-groups.update', $beneficiaryGroup) }}" method="POST">
                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ $beneficiaryGroup->name }}" required class="w-full px-6 py-4 bg-silk border-2 border-transparent rounded-2xl text-sm font-bold text-royal-navy focus:bg-white focus:border-gold transition-all outline-none" placeholder="Contoh: SD Negeri 01 Bukit Tinggi">
                        </div>

                        <div>
                            <label class="block text-[10px] font-black text-royal-navy uppercase tracking-[0.2em] mb-3">Lokasi / Alamat Wilayah</label>
                            <input type="text" name="location" value="{{ $beneficiaryGroup->location }}" class="w-full px-6 py-4 bg-silk border-2 border-transparent rounded-2xl text-sm font-bold text-royal-navy focus:bg-white focus:border-gold transition-all outline-none" placeholder="Contoh: Jl. Merdeka No. 10">
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                <label class="block text-[10px] font-black text-royal-navy uppercase tracking-[0.2em] mb-3">Latitude</label>
                                <input type="number" step="any" name="latitude" value="{{ $beneficiaryGroup->latitude }}" class="w-full px-6 py-4 bg-silk border-2 border-transparent rounded-2xl text-sm font-bold text-royal-navy focus:bg-white focus:border-gold transition-all outline-none" placeholder="Contoh: 3.010091">
                            </div>
                            <div>
                                <label class="block text-[10px] font-black text-royal-navy uppercase tracking-[0.2em] mb-3">Longitude</label>
                                <input type="number" step="any" name="longitude" value="{{ $beneficiaryGroup->longitude }}" class="w-full px-6 py-4 bg-silk border-2 border-transparent rounded-2xl text-sm font-bold text-royal-navy focus:bg-white focus:border-gold transition-all outline-none" placeholder="Contoh: 99.111776">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="total_beneficiaries" value="{{ $beneficiaryGroup->total_beneficiaries }}" class="w-full px-6 py-4 bg-silk border-2 border-transparent rounded-2xl text-sm font-bold text-royal-navy focus:bg-white focus:border-gold transition-all outline-none" placeholder="0">
                        </div>
