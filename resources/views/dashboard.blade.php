    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8">
                <!-- Service Units -->
                <a href="{{ route('beneficiary-groups.index') }}" class="block bg-white p-6 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-gray-100 hover:border-royal-navy/30 transition-all duration-500 group relative overflow-hidden">
                    <div class="absolute top-0 right-0 w-24 sm:w-32 h-24 sm:h-32 bg-royal-navy/5 -mr-12 sm:-mr-16 -mt-12 sm:-mt-16 rounded-full group-hover:bg-royal-navy/10 transition-colors"></div>
                    <div class="relative">
                        <div class="text-gray-400 font-black uppercase tracking-[0.2em] text-[10px] mb-3 sm:mb-4">Total Unit Layanan</div>
                        <div class="flex items-end justify-between">
                            <div class="text-royal-navy text-4xl sm:text-5xl font-black font-playfair leading-none">{{ $stats['units_count'] }}</div>
                            <div class="w-10 h-10 rounded-xl bg-royal-navy/10 flex items-center justify-center text-royal-navy group-hover:scale-110 transition-transform">
                ...
                <a href="{{ route('beneficiary-groups.index') }}" class="block bg-white p-6 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-gray-100 hover:border-gold/30 transition-all duration-500 group relative overflow-hidden">
                    ...
                    <div class="relative">
                        <div class="text-gray-400 font-black uppercase tracking-[0.2em] text-[10px] mb-3 sm:mb-4">Total Penerima Manfaat</div>
                        <div class="flex items-end justify-between">
                            <div class="text-royal-navy text-4xl sm:text-5xl font-black font-playfair leading-none">{{ number_format($stats['beneficiaries_count']) }}</div>
