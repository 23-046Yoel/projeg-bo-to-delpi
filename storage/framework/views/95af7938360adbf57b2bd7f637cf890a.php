...
function aiChatBot() {
    return {
        ...
        async sendMessage() {
            ...
            try {
                const response = await fetch('<?php echo e(route("chat.query")); ?>', {
                    method: 'POST',
                    headers: {
...
<?php /**PATH C:\laragon\www\projeg Bo To Delpi\resources\views/components/ai-chatbot.blade.php ENDPATH**/ ?>