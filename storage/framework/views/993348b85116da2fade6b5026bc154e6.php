            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                ...
                <div class="bg-white p-6 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-gray-100 hover:border-gold/30 transition-all duration-500 group relative overflow-hidden">
                    ...
                    <div class="relative">
                        ...
                        <div class="flex items-end justify-between">
                            <div class="text-royal-navy text-4xl sm:text-5xl font-black font-playfair leading-none"><?php echo e($stats['suppliers_count']); ?></div>
                ...
                <div class="bg-white p-6 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-gray-100 hover:border-gold/30 transition-all duration-500 group relative overflow-hidden">
                    ...
                    <div class="relative">
                        ...
                        <div class="flex items-end justify-between">
                            <div class="text-royal-navy text-4xl sm:text-5xl font-black font-playfair leading-none"><?php echo e($stats['beneficiaries_count']); ?></div>
                            <div class="w-10 h-10 rounded-xl bg-gold/10 flex items-center justify-center text-gold group-hover:scale-110 transition-transform">
                ...
                <div class="bg-white p-6 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-gray-100 hover:border-gold/30 transition-all duration-500 group relative overflow-hidden">
                    ...
                    <div class="relative">
                        ...
                        <div class="flex items-end justify-between">
                            <div class="text-royal-navy text-4xl sm:text-5xl font-black font-playfair leading-none"><?php echo e($stats['materials_count']); ?></div>
                            <div class="w-10 h-10 rounded-xl bg-gold/10 flex items-center justify-center text-gold group-hover:scale-110 transition-transform">
                    ...
                    <div class="relative">
                        ...
                        <div class="flex items-end justify-between">
                            <div class="text-white text-2xl sm:text-3xl font-black font-playfair leading-none tracking-tight">
                                <span class="text-gold text-lg mr-1 italic">Rp</span><?php echo e(number_format($stats['total_payments'], 0, ',', '.')); ?>
            ...
            <div class="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.03)] border border-gray-100 overflow-hidden">
                    <div class="p-8 border-b border-gray-50 flex items-center justify-between">
                        ...
                        <a href="<?php echo e(route('suppliers.index')); ?>" class="text-[10px] font-black text-royal-navy hover:text-gold transition-colors uppercase tracking-widest border-b-2 border-gold pb-1">Lihat Semua</a>
                    </div>
                    <div class="p-0">
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                <?php $__empty_1 = true; $__currentLoopData = $latest_suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50/30 transition-colors">
                                    <td class="px-8 py-5">
                                        <div class="font-bold text-royal-navy text-sm"><?php echo e($supplier->name); ?></div>
                                        <div class="text-[10px] text-gray-400 font-medium"><?php echo e($supplier->village); ?></div>
                                    </td>
                                    <td class="px-8 py-5">
                                        <span class="px-3 py-1 bg-royal-navy/5 text-royal-navy text-[10px] font-extrabold rounded-full"><?php echo e($supplier->sppg->name ?? 'N/A'); ?></span>
                                    </td>
                                    <td class="px-8 py-5">
                                        <div class="text-xs text-gray-500 line-clamp-1"><?php echo e($supplier->items); ?></div>
                                    </td>
                                </tr>
                ...
                <div class="bg-white rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.03)] border border-gray-100 overflow-hidden">
                    <div class="p-8 border-b border-gray-50 flex items-center justify-between">
                        ...
                        <a href="<?php echo e(route('complaints.index')); ?>" class="text-[10px] font-black text-royal-navy hover:text-red-500 transition-colors uppercase tracking-widest border-b-2 border-red-500 pb-1">Lihat Semua</a>
                    </div>
                    <div class="p-0">
                        <table class="w-full text-left border-collapse">
                            <thead>
                            ...
                            <tbody class="divide-y divide-gray-50">
                                <?php $__empty_1 = true; $__currentLoopData = $latest_complaints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $complaint): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50/30 transition-colors">
                                    <td class="px-8 py-5">
                                        <div class="font-bold text-royal-navy text-sm"><?php echo e($complaint->name); ?></div>
                                        <div class="text-[10px] text-gray-400 font-medium"><?php echo e($complaint->phone); ?></div>
                                    </td>
                                    <td class="px-8 py-5">
                                        <div class="text-xs font-bold text-gray-600"><?php echo e($complaint->type); ?></div>
                                        <div class="text-[10px] text-gray-400 line-clamp-1 italic">"<?php echo e($complaint->description); ?>"</div>
                                    </td>
                                    <td class="px-8 py-5">
                                        <?php
                                        ...
                                        ?>
                                        <span class="px-3 py-1 <?php echo e($badgeClass); ?> text-[10px] font-extrabold rounded-full"><?php echo e($complaint->status); ?></span>
                                    </td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\projeg Bo To Delpi\resources\views/dashboard.blade.php ENDPATH**/ ?>