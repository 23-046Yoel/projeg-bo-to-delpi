...
<body class="antialiased">
    ...
    ?>
    <?php if($latest_news->count() > 0 || $active_aspirations->count() > 0): ?>
    <div class="ticker-wrap sticky top-0 z-50">
        <div class="ticker">
            ...
            <?php $__currentLoopData = $active_aspirations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span class="mx-8 font-semibold text-sm tracking-widest text-white/80">
                    💬 <em><?php echo e($asp->sender_name); ?> (<?php echo e($asp->location); ?>):</em> <?php echo e(Str::limit($asp->content, 80)); ?>
    ...
    <section class="max-w-7xl mx-auto px-6 py-24 border-t border-slate-100">
        <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            ...
            <a href="<?php echo e(route('kitchens.index')); ?>" class="px-6 py-3 rounded-lg border border-slate-200 text-sm font-bold hover:bg-slate-50 transition-all flex items-center gap-2 whitespace-nowrap">
                Lihat Semua Dapur
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
            </a>
        </div>
        <?php $kitchens = \App\Models\Sppg::withCount('beneficiaries')->latest()->take(3)->get(); ?>
        <div class="grid md:grid-cols-3 gap-6">
            ...
            ?>
            <a href="<?php echo e(route('kitchens.show', $kitchen->slug ?? $kitchen->id)); ?>" class="block group bg-white rounded-[2rem] border border-slate-100 shadow-lg overflow-hidden hover:-translate-y-2 transition-all duration-300">
                <div class="relative h-40 bg-gradient-to-br from-[#0F172A] to-slate-700">
                    <?php if($kitchen->image_path): ?>
                    <img src="<?php echo e(Storage::url($kitchen->image_path)); ?>" class="w-full h-full object-cover opacity-60 group-hover:opacity-80 transition-opacity" alt="<?php echo e($kitchen->name); ?>">
                    <?php else: ?>
                ...
                <div class="p-6">
                    <h3 class="font-black text-[#0F172A] playfair italic mb-1"><?php echo e($kitchen->name); ?></h3>
                    <p class="text-[10px] text-[#D4AF37] font-black uppercase tracking-widest"><?php echo e($kitchen->beneficiaries_count); ?> Penerima Manfaat</p>
                    <?php if($kitchen->address): ?>
                    <p class="text-xs text-slate-400 mt-2"><?php echo e($kitchen->address); ?></p>
                    <?php endif; ?>
                </div>
            </a>
