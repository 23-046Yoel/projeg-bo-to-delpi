...
<body class="antialiased">
    ...
    <div class="ticker-container">
        ...
        <div class="ticker-content-wrap">
            <div class="ticker-track">
                <?php $__currentLoopData = $ticker_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="ticker-item">
                        <span class="ticker-label" style="color: <?php echo e($item['color']); ?>; background: <?php echo e($item['color']); ?>15">
                            <span class="ticker-dot"></span> <?php echo e($item['label']); ?>
        ...
        <div class="flex items-center gap-6">
            ...
            <div class="flex items-center gap-4 hidden md:flex opacity-80 transition-opacity hover:opacity-100">
                <a href="https://bgn.go.id" target="_blank" rel="noopener">
                    <img src="<?php echo e(asset('images/bgn_logo.png')); ?>" alt="Badan Gizi Nasional" class="h-10 w-auto hover:opacity-100 opacity-80 transition-opacity">
                </a>
                <img src="<?php echo e(asset('images/ala_delphi.png')); ?>" alt="Yayasan ALA DELPHI" class="h-10 w-auto">
            </div>
        </div>
        <div class="flex gap-4">
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(url('/dashboard')); ?>" class="px-6 py-2 rounded-full hero-gradient text-white font-bold text-sm hover:scale-105 transition-all">Dashboard</a>
            <?php else: ?>
                <a href="<?php echo e(route('suppliers.register')); ?>" class="px-6 py-2 rounded-full border border-slate-200 text-slate-500 font-bold text-sm hover:bg-slate-50 transition-all">Jadi Pemasok</a>
                <a href="<?php echo e(route('login.wa')); ?>" class="px-6 py-2 rounded-full border-2 border-[#0F172A] text-[#0F172A] font-bold text-sm hover:bg-[#0F172A] hover:text-white transition-all">Masuk WA</a>
            <?php endif; ?>
        </div>
    </nav>
    ...
    <section class="max-w-7xl mx-auto px-6 py-12 lg:py-24 grid lg:grid-cols-2 gap-12 items-center">
        <div>
            ...
            <div class="flex flex-wrap gap-4">
                <a href="<?php echo e(route('login.wa')); ?>" class="px-8 py-4 rounded-xl hero-gradient text-white font-black text-xs tracking-[0.2em] uppercase shadow-xl shadow-slate-900/20 hover:scale-105 transition-all">Mulai Kontribusi</a>
                <a href="<?php echo e(route('suppliers.register')); ?>" class="px-8 py-4 rounded-xl border-2 border-gold text-gold font-black text-xs tracking-[0.2em] uppercase hover:bg-gold hover:text-white transition-all shadow-lg shadow-gold/10">Jadi Pemasok</a>
            </div>
        </div>
        <div class="relative">
            ...
            <div class="glass p-4 rounded-[2.5rem] relative overflow-hidden shadow-2xl">
                <img src="<?php echo e(asset('images/indonesia_mbg.png')); ?>" alt="Makan Bergizi Gratis" class="rounded-[2rem] w-full h-[500px] object-cover">
                <div class="absolute inset-0 bg-gradient-to-t from-[#0F172A]/80 to-transparent flex items-end p-12">
                    <div>
                        ...
                        <p class="text-white text-3xl font-black playfair italic tracking-tight"><?php echo e(number_format($stats['beneficiaries_count'])); ?> Penerima Manfaat</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="stats" class="bg-[#0F172A] py-20 text-white relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-12 relative z-10">
            <div class="text-center">
                <div class="text-[#D4AF37] text-4xl font-black mb-2"><?php echo e($stats['posts_count']); ?></div>
            ...
            <div class="text-center border-x border-slate-800 px-12">
                <div class="text-[#D4AF37] text-4xl font-black mb-2"><?php echo e($stats['beneficiaries_per_kitchen']); ?></div>
                <div class="text-slate-400 text-xs uppercase tracking-widest font-bold">Penerima Manfaat Tiap Dapur</div>
            </div>
            <div class="text-center">
                <div class="text-[#D4AF37] text-4xl font-black mb-2"><?php echo e($stats['tutorials_count']); ?></div>
    ...
    <section class="bg-slate-50 py-24 border-y border-slate-100 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div class="grid md:grid-cols-2 gap-8 mt-12">
                ...
                <div class="group bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-xl hover:shadow-2xl transition-all duration-500 relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <a href="<?php echo e(route('nutrition.consultation')); ?>" class="inline-flex items-center gap-3 px-8 py-4 bg-[#0F172A] text-white font-black text-xs tracking-widest uppercase rounded-2xl group-hover:bg-gold transition-all duration-300">
                            Daftar Konsultasi
                ...
                <div class="group bg-[#0F172A] rounded-[2.5rem] p-10 border border-white/5 shadow-2xl hover:shadow-gold/20 transition-all duration-500 relative overflow-hidden">
                    ...
                    <div class="relative z-10 text-white">
                        ...
                        <a href="<?php echo e(route('reports.daily')); ?>" class="inline-flex items-center gap-3 px-8 py-4 bg-gold text-white font-black text-xs tracking-widest uppercase rounded-2xl hover:bg-white hover:text-[#0F172A] transition-all duration-300">
                            Upload Laporan Sesi
                            <svg class="w-4 h-4 group-hover:translate-x-2 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                        </a>
                    </div>
            ...
            <div class="mt-16">
                ...
                <form action="<?php echo e(route('nutrition.consultation.store')); ?>" method="POST"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name')); ?>" required placeholder="contoh: Siti Rahma"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="contoh: 08123456789"
                                   class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-bold text-slate-800 placeholder-slate-300 focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none transition-all">
                        </div>
                        <div class="space-y-2">
                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest">Usia (tahun) *</label>
                            <input type="number" name="age" value="<?php echo e(old('age')); ?>" required min="0" placeholder="25"
                                   class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-bold text-slate-800 placeholder-slate-300 focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none transition-all">
                        </div>
                        <div class="space-y-2">
                            ...
                            <select name="gender" required
                                ...
                                <option value="" disabled <?php echo e(old('gender') ? '' : 'selected'); ?>>Pilih...</option>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" name="weight" value="<?php echo e(old('weight')); ?>" required step="0.1" placeholder="60"
                                   class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-bold text-slate-800 placeholder-slate-300 focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none transition-all">
                        </div>
                        <div class="space-y-2">
                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest">Tinggi Badan (cm) *</label>
                            <input type="number" name="height" value="<?php echo e(old('height')); ?>" required step="0.1" placeholder="165"
                                   class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-bold text-slate-800 placeholder-slate-300 focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none transition-all">
                        </div>
                        <div class="space-y-2 md:col-span-2">
                            ...
                            <select name="goal" required
                                    class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-bold text-slate-800 focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none transition-all">
                                <option value="" disabled <?php echo e(old('goal') ? '' : 'selected'); ?>>Pilih tujuan konsultasi...</option>
                        ...
                        <div class="space-y-2 md:col-span-2">
                            ...
                            <textarea name="medical_history" rows="3" placeholder="contoh: Diabetes, Alergi Seafood, dll..."
                                      class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-bold text-slate-800 placeholder-slate-300 focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none transition-all resize-none"><?php echo e(old('medical_history')); ?></textarea>
                        </div>
                    </div>
                    <div class="mt-8">
                        <button type="submit"
    ...
    <section class="max-w-7xl mx-auto px-6 py-24">
        <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            ...
            <a href="<?php echo e(route('login.wa')); ?>" class="px-6 py-3 rounded-lg border border-slate-200 text-sm font-bold hover:bg-slate-50 transition-all flex items-center gap-2">
        ...
        <?php if($dishVideos->count() > 0): ?>
        <div class="grid md:grid-cols-3 gap-8">
            <?php $__currentLoopData = $dishVideos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dish): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $ytId = $extractYoutubeId($dish->youtube_url); ?>
            <div class="youtube-card glass rounded-[1.5rem] overflow-hidden shadow-lg border border-slate-100">
                <div class="bg-slate-200 relative" style="aspect-ratio:9/16;">
                    <?php if($ytId): ?>
                        <iframe class="w-full h-full absolute inset-0" src="https://www.youtube.com/embed/<?php echo e($ytId); ?>?controls=1&modestbranding=1&rel=0" title="<?php echo e($dish->name); ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    <?php else: ?>
                ...
                <div class="p-6">
                    <h3 class="font-black text-[#0F172A] mb-1 italic"><?php echo e($dish->name); ?></h3>
                    <p class="text-xs text-[#D4AF37] font-bold uppercase tracking-wider">Tutorial Langkah-demi-Langkah</p>
                    <?php if($dish->description): ?>
                    <p class="text-xs text-gray-500 mt-2 line-clamp-2"><?php echo e($dish->description); ?></p>
                    <?php endif; ?>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        ?>
        <div class="grid md:grid-cols-3 gap-8">
            <?php $__currentLoopData = $defaultVideos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vid): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="youtube-card glass rounded-[1.5rem] overflow-hidden shadow-lg border border-slate-100">
                
                <div class="relative bg-black" style="aspect-ratio:9/16;">
                    <iframe
                        class="absolute inset-0 w-full h-full"
                        src="https://www.youtube.com/embed/<?php echo e($vid['ytId']); ?>?controls=1&modestbranding=1&rel=0&playsinline=1"
                        title="<?php echo e($vid['title']); ?>"
                        frameborder="0"
                ...
                <div class="p-6">
                    <span class="inline-block px-2 py-0.5 rounded-full bg-[#D4AF37]/10 text-[#B8860B] text-[10px] font-black uppercase tracking-widest mb-2"><?php echo e($vid['tag']); ?></span>
                    <h3 class="font-black text-[#0F172A] mb-1 italic text-base leading-tight"><?php echo e($vid['title']); ?></h3>
                    <p class="text-xs text-gray-500 mb-4 leading-relaxed"><?php echo e($vid['desc']); ?></p>
                    <a href="<?php echo e($vid['href']); ?>" target="_blank" rel="noopener"
    ...
    <section class="max-w-7xl mx-auto px-6 py-24 border-t border-slate-100">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="glass p-8 rounded-[2.5rem] border border-slate-100 hover:border-gold/30 bg-white transition-all group">
                ...
                <a href="<?php echo e(route('prices.index')); ?>" class="text-[10px] font-black text-gold uppercase tracking-widest flex items-center group/link">
                    Cek Detail
            ...
            <div class="glass p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-300/30 bg-white transition-all group">
                ...
                <a href="<?php echo e(route('recap.index')); ?>" class="text-[10px] font-black text-emerald-600 uppercase tracking-widest flex items-center group/link">
                    Laporan Ringkas
                    <svg class="w-4 h-4 ml-2 group-hover/link:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                </a>
            </div>
            ...
            <div class="glass p-8 rounded-[2.5rem] border border-royal-navy/10 bg-royal-navy transition-all group">
                ...
                <a href="<?php echo e(route('suppliers.register')); ?>" class="text-[10px] font-black text-gold uppercase tracking-widest flex items-center group/link">
                    Daftar Sekarang
                    <svg class="w-4 h-4 ml-2 group-hover/link:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                </a>
            </div>
            ...
            <div class="glass p-8 rounded-[2.5rem] border border-red-100 hover:border-red-300/30 bg-white transition-all group">
                ...
                <a href="<?php echo e(route('complaints.create')); ?>" class="text-[10px] font-black text-red-600 uppercase tracking-widest flex items-center group/link">
                    Kirim Aduan
                    <svg class="w-4 h-4 ml-2 group-hover/link:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                </a>
            </div>
    ...
    <section class="max-w-7xl mx-auto px-6 py-24 border-t border-slate-100">
        <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            ...
            <div class="flex flex-col gap-3">
                <a href="<?php echo e(route('community-prices.index')); ?>" class="px-6 py-3 rounded-lg border border-slate-200 text-sm font-bold hover:bg-slate-50 transition-all flex items-center gap-2">
        ...
        <?php $communityPrices = \App\Models\CommunityPrice::latest()->take(4)->get(); ?>
        <?php if($communityPrices->count() > 0): ?>
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            <?php $__currentLoopData = $communityPrices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-[1.5rem] border border-slate-100 shadow-md p-5 hover:shadow-lg transition-shadow">
                <div class="w-10 h-10 rounded-2xl bg-[#D4AF37]/10 flex items-center justify-center text-xl font-black text-[#D4AF37] mb-3">
                    <?php echo e(mb_substr($cp->item_name, 0, 1)); ?>

                </div>
                <h4 class="font-black text-[#0F172A] text-sm mb-1"><?php echo e($cp->item_name); ?></h4>
                <p class="text-lg font-black text-[#D4AF37]">Rp <?php echo e(number_format($cp->price, 0, ',', '.')); ?></p>
                <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest">/ <?php echo e($cp->unit); ?></p>
        ...
        <div class="text-center py-16 bg-white rounded-[2rem] border border-slate-100">
            ...
            <a href="<?php echo e(route('community-prices.index')); ?>" class="px-6 py-3 bg-[#0F172A] text-[#D4AF37] font-black text-xs uppercase tracking-widest rounded-xl hover:scale-105 transition-all">Laporan Sekarang</a>
        </div>
        <?php endif; ?>
    </section>
    ...
    <section class="bg-silk/30 py-24">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                ?>
                <?php $__empty_1 = true; $__currentLoopData = $news_feed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-white rounded-[2rem] overflow-hidden shadow-xl border border-slate-100 group">
                        <div class="relative aspect-square overflow-hidden">
                            <?php if($post->image_path): ?>
                                <img src="<?php echo e(Storage::url($post->image_path)); ?>" alt="<?php echo e($post->title); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                            <?php else: ?>
                            ...
                            <div class="absolute top-4 left-4">
                                <span class="px-3 py-1 bg-white/90 backdrop-blur-md rounded-full text-[10px] font-black uppercase tracking-widest text-royal-navy shadow-sm">
                                    <?php echo e($post->sppg->name ?? 'Update SPPG'); ?>

                                </span>
                            </div>
                        </div>
                        <div class="p-6">
                            <h3 class="font-bold text-royal-navy text-sm line-clamp-1 mb-2"><?php echo e($post->title); ?></h3>
                            <p class="text-xs text-gray-500 line-clamp-2 mb-4 leading-relaxed"><?php echo e($post->content); ?></p>
    ...
    <section class="bg-[#0F172A] py-24">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <?php if(session('aspiration_success')): ?>
            <div class="p-4 bg-emerald-500/20 border border-emerald-500/30 rounded-2xl text-emerald-300 font-bold mb-8"><?php echo e(session('aspiration_success')); ?></div>
            <?php endif; ?>
            <form action="<?php echo e(route('aspirations.store')); ?>" method="POST" class="bg-white/5 border border-white/10 rounded-[2rem] p-8 text-left">
                <?php echo csrf_field(); ?>
    ...
    <section class="max-w-7xl mx-auto px-6 py-24 border-t border-slate-100">
        ...
        <div class="grid md:grid-cols-3 gap-6 mb-10">
            ...
            ?>
            <?php $__currentLoopData = $juknisLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $juknis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e($juknis['url']); ?>" target="_blank" rel="noopener"
               class="group bg-white border border-slate-100 rounded-[2rem] p-8 shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                <div class="w-12 h-12 rounded-2xl flex items-center justify-center mb-6
                    <?php echo e($juknis['color'] === 'blue' ? 'bg-blue-50 text-blue-500 group-hover:bg-blue-500 group-hover:text-white' : ''); ?>

                    <?php echo e($juknis['color'] === 'emerald' ? 'bg-emerald-50 text-emerald-500 group-hover:bg-emerald-500 group-hover:text-white' : ''); ?>

                    <?php echo e($juknis['color'] === 'yellow' ? 'bg-[#D4AF37]/10 text-[#D4AF37] group-hover:bg-[#D4AF37] group-hover:text-white' : ''); ?>

                    transition-all">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($juknis['icon']); ?>"/>
                    </svg>
                </div>
                <h3 class="playfair text-lg font-black italic text-[#0F172A] mb-3"><?php echo e($juknis['title']); ?></h3>
                <p class="text-gray-500 text-sm leading-relaxed mb-4"><?php echo e($juknis['desc']); ?></p>
                <span class="text-[10px] font-black uppercase tracking-widest
                    <?php echo e($juknis['color'] === 'blue' ? 'text-blue-600' : ''); ?>

                    <?php echo e($juknis['color'] === 'emerald' ? 'text-emerald-600' : ''); ?>

                    <?php echo e($juknis['color'] === 'yellow' ? 'text-[#D4AF37]' : ''); ?>
        ...
        <div class="relative bg-white rounded-[3rem] border border-blue-100 shadow-2xl overflow-hidden group">
            ...
            <div class="px-8 py-5 bg-blue-50/50 border-t border-blue-100 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <p class="text-[9px] text-slate-400 text-center font-bold">Terakhir diperbarui: <?php echo e(date('d M Y')); ?></p>
            </div>
        </div>
    </section>
        ...
        <div class="flex flex-wrap justify-center items-center gap-12 md:gap-32">
            <div class="flex flex-col items-center gap-6 group text-center">
                <div class="p-8 rounded-[2.5rem] bg-white border border-slate-100 shadow-2xl shadow-slate-200/50 group-hover:shadow-blue-500/10 group-hover:border-blue-100 transition-all duration-500 transform group-hover:-translate-y-3 flex items-center justify-center">
                    <img src="<?php echo e(asset('images/bgn_logo.png')); ?>" alt="BGN" class="h-28 md:h-44 w-auto object-contain">
                </div>
            ...
            <div class="flex flex-col items-center gap-6 group text-center">
                <div class="p-8 rounded-[2.5rem] bg-white border border-slate-100 shadow-2xl shadow-slate-200/50 group-hover:shadow-red-500/10 group-hover:border-red-100 transition-all duration-500 transform group-hover:-translate-y-3 flex items-center justify-center">
                    <img src="<?php echo e(asset('images/ala_delphi.png')); ?>" alt="Yayasan ALA DELPHI" class="h-28 md:h-44 w-auto object-contain">
                </div>
                <div class="flex flex-col items-center">
        ...
        <div class="relative rounded-[3rem] overflow-hidden hero-gradient p-12 lg:p-24 text-center">
            ...
            <div class="relative z-10 max-w-3xl mx-auto">
                ...
                <div class="flex flex-wrap justify-center gap-6">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="px-10 py-5 rounded-2xl bg-[#D4AF37] text-white font-black text-xs tracking-[0.2em] uppercase shadow-2xl shadow-gold/20 hover:scale-105 hover:bg-white hover:text-[#0F172A] transition-all duration-300">
                            Masuk ke Dashboard
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login.wa')); ?>" class="px-10 py-5 rounded-2xl bg-[#D4AF37] text-white font-black text-xs tracking-[0.2em] uppercase shadow-2xl shadow-gold/20 hover:scale-105 hover:bg-white hover:text-[#0F172A] transition-all duration-300">
                            Mulai Sekarang (WA)
                        </a>
                        <a href="<?php echo e(route('suppliers.register')); ?>" class="px-10 py-5 rounded-2xl border border-white/20 text-white font-black text-xs tracking-[0.2em] uppercase hover:bg-white/10 transition-all duration-300">
                            Daftar Pemasok
                        </a>
                    <?php endif; ?>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'w-12 h-auto invert']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-12 h-auto invert']); ?>
...
<?php endif; ?>
            ...
            <div>
                ...
                <ul class="space-y-4 text-slate-400 text-sm font-medium">
                    <li><a href="<?php echo e(url('/')); ?>" class="hover:text-white transition-all">Beranda</a></li>
                    <li><a href="<?php echo e(route('kitchens.index')); ?>" class="hover:text-white transition-all">Profil Dapur</a></li>
                    <li><a href="<?php echo e(route('prices.index')); ?>" class="hover:text-white transition-all">Harga Pangan</a></li>
                    <li><a href="<?php echo e(route('community-prices.index')); ?>" class="hover:text-white transition-all">Harga Komunitas</a></li>
                    <li><a href="<?php echo e(route('complaints.create')); ?>" class="hover:text-white transition-all">Aduan Publik</a></li>
...
<?php /**PATH C:\laragon\www\projeg Bo To Delpi\resources\views/welcome.blade.php ENDPATH**/ ?>